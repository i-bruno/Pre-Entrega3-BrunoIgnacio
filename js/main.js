...
let fichaListas
    ...
    switch(parseInt(cantidadListas)){
        case 2:
            ...
            fichaListas.innerHTML = "<div class='divLista1' id='divLista1'><h3> " + listaGanadora.nombre + " </h3><h4>Votos: " + listaGanadora.votos + "</h4></div><div class='divLista2' id='divLista2'><h3>" + lista2.nombre + "</h3><h4>Votos: " + lista2.votos + "</h4></div>";
